...
function TitleScreen(){return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"title-screen",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h1",{className:"title",children:"GAME TITLE"}),/*#__PURE__*/(0,jsx_runtime.jsx)("button",{onClick:function onClick(){return Interop.GetType('ReactUnityBridge').StartGameClicked();},children:"START"})]});}
...
function formatTime(seconds){var mins=Math.floor(seconds/60);var secs=Math.floor(seconds-mins*60);return"".concat(mins,":").concat(pad(secs,2));}function LevelEnd(){var globals=useGlobals();var scoreLevel=useReactiveValue(globals.scoreLevel);var scoreTime=useReactiveValue(globals.scoreTime);var scoreTimeLimit=useReactiveValue(globals.scoreTimeLimit);var scoreDamages=useReactiveValue(globals.scoreDamages);var scoreDeliveries=useReactiveValue(globals.scoreDeliveries);var scoreDeliveriesGoal=useReactiveValue(globals.scoreDeliveriesGoal);var scoreEarnings=useReactiveValue(globals.scoreEarnings);var handleNext=function handleNext(){Interop.GetType('ReactUnityBridge').NextLevelClicked();};return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"level-end",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h1",{className:"title",children:"CHECKPOINT ".concat(scoreLevel," REACHED")}),/*#__PURE__*/(0,jsx_runtime.jsx)("h2",{className:"stat",children:"TIME: ".concat(formatTime(scoreTime)," / ").concat(formatTime(scoreTimeLimit))}),/*#__PURE__*/(0,jsx_runtime.jsx)("h2",{className:"stat",children:"ANTIDOTES DELIVERED: ".concat(scoreDeliveries," / ").concat(scoreDeliveriesGoal)}),/*#__PURE__*/(0,jsx_runtime.jsx)("h2",{className:"stat",children:"DAMAGES: $".concat(scoreDamages)}),/*#__PURE__*/(0,jsx_runtime.jsx)("h2",{className:"stat",children:"EARNINGS: $".concat(scoreEarnings)}),/*#__PURE__*/(0,jsx_runtime.jsx)("button",{onClick:function onClick(){return handleNext();},children:"NEXT"})]});}
;// CONCATENATED MODULE: ./src/hud.tsx
function Hud(){var globals=useGlobals();var timerText=useReactiveValue(globals.timerText);var damagesText=useReactiveValue(globals.damagesText);return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"game-hud",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"top-bar",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h1",{className:"title",children:timerText}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"spacer"}),/*#__PURE__*/(0,jsx_runtime.jsx)("h1",{className:"title",children:damagesText})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"content"})]});}
;// CONCATENATED MODULE: ./src/dialogue.tsx
var conversations=new Map();conversations["game_intro"]=[{speaker:"Handler",text:"You're already on the road? Good. This package is of utmost importance. \nYou have 3 minutes to get it to the president."},{speaker:"Agent",text:"3 Minutes?!"},{speaker:"Handler",text:"Yeah, so be quick. And don't worry if the car gets a little banged up. \nWe'll just deduct the repair fees from your pay."}];conversations["delivery_intro"]=[{speaker:"Handler",text:"By the way, there appears to be a pandemic going around."},{speaker:"Handler",text:"Could you also distribute these medicine at the marked buildings? We'll give you a bonus for it."}];conversations["ending_good"]=[{speaker:"Agent",text:"Mr. President? Express delivery for you."},{speaker:"President",text:"Ah! My bingsu. I was waiting for this."},{speaker:"President",text:"And it hasn't melted yet. Well done. We'll give you a promotion."}];conversations["ending_bad"]=[{speaker:"Agent",text:"Mr. President? Express delivery for you."},{speaker:"President",text:"Ah! My bingsu. I was waiting for this."},{speaker:"President",text:"Wait. What is this? It's all MELTED! Have this guy fired!"}];function Dialogue(){var globals=useGlobals();var conversationKey=useReactiveValue(globals.conversationKey);var _useState=(0,react.useState)(0),_useState2=slicedToArray_slicedToArray(_useState,2),index=_useState2[0],setIndex=_useState2[1];var currentConversation=conversations[conversationKey];var currentMessage=currentConversation?currentConversation[index]:null;var hasNext=currentConversation&&currentConversation.length>index+1;var handleNext=function handleNext(){// Advance conversation or call DialogueFinished
if(hasNext){setIndex(index+1);}else{Interop.GetType('ReactUnityBridge').DialogueFinished();}};return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"dialogue-bar",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"content",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h1",{className:"title",children:currentMessage?currentMessage.speaker:""}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"gradient-rule"}),/*#__PURE__*/(0,jsx_runtime.jsx)("p",{className:"message",children:currentMessage?currentMessage.text:""}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"gradient-rule"})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("button",{onClick:function onClick(){return handleNext();},children:hasNext?"CONTINUE":"START"})]});}
