...
// ];
conversations["ending_good"]=[{bg:"ending_bg1",speaker:"Agent",text:"Mr. Chairman? I have the delivery for you."},{bg:"ending_bg1",speaker:"Chairman",text:"Ah! Ice cream from The Scoop. A special treat!"},{bg:"ending_good",speaker:"Chairman",text:"And it hasn't melted yet. Well done agent. We'll give you a promotion."}];conversations["ending_bad"]=[{bg:"ending_bg1",speaker:"Agent",text:"Mr. Chairman? Express delivery for you."},{bg:"ending_bg1",speaker:"Chairman",text:"Ah! Ice cream from The Scoop. A special treat!"},{bg:"ending_bad",speaker:"Chairman",text:"What is this? It's all MELTED! Have this guy fired!"}];function Dialogue(){var globals=useGlobals();var continueValue=useReactiveValue(globals["continue"]);var conversationKey=useReactiveValue(globals.conversationKey);var _useState=(0,react.useState)(0),_useState2=slicedToArray_slicedToArray(_useState,2),index=_useState2[0],setIndex=_useState2[1];var currentConversation=conversations[conversationKey];var currentMessage=currentConversation?currentConversation[index]:null;var hasNext=currentConversation&&currentConversation.length>index+1;var bgImage=currentMessage?currentMessage.bg?currentMessage.bg:"none":"none";var handleNext=function handleNext(){// Advance conversation or call DialogueFinished
