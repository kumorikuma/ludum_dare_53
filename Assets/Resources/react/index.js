...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@font-face{font-family:\"NotoSans\";src:url(resource:NotoSansJP)}@font-face{font-family:\"NotoSansLight\";src:url(resource:NotoSansLight)}.dialogue-background{position:fixed;width:100%;height:100%;background-size:cover;background-position:center center;background-repeat:no-repeat}.dialogue-bar{position:fixed;bottom:0;left:0;right:0;height:250px;background:linear-gradient(90deg, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.8) 20%, rgba(0, 0, 0, 0.8) 80%, rgba(0, 0, 0, 0.5));display:flex;flex-direction:column;padding:24px}.dialogue-bar .content{display:flex;flex-direction:column;width:100%;align-items:flex-start;justify-content:flex-start;text-align:left;font-family:\"NotoSansLight\"}.dialogue-bar h1{height:40px}.dialogue-bar button{margin-right:24px;align-self:flex-end;background-color:rgba(0,0,0,0);color:#ff0}.dialogue-bar p{height:100px}.gradient-rule{height:1px;width:400px;background-image:linear-gradient(90deg, transparent, rgba(255, 255, 255, 0.8), transparent);margin:16px 0}.title{color:#fff;font-size:24px}.message{padding:24px;padding-left:64px;color:#fff;font-size:18px}.spacer{flex-grow:1}.title-screen{display:flex;flex-direction:column;height:100%;justify-content:center;align-items:center}.title-screen h1{margin-top:-100px;width:100%;color:#fff;font-size:28pt;text-align:center;font-family:\"NotoSans\"}.title-screen button{margin-top:40px;font-size:24pt;color:#ff0;background-color:rgba(0,0,0,0)}.main-menu{display:flex;flex-direction:column;height:100%}.main-menu .rule{height:1px;align-self:stretch;background-image:linear-gradient(90deg, transparent, rgba(255, 255, 255, 0.8), transparent);margin:0px 0}.main-menu .top-bar{height:100px;background-color:rgba(0,0,0,.8)}.main-menu .content{flex-grow:1}.main-menu .bottom-bar{height:75px;background-color:rgba(0,0,0,.8)}.game-hud{display:flex;flex-direction:column;height:100%}.game-hud .rule{height:1px;align-self:stretch;margin:0px 0}.game-hud .top-bar{display:flex;flex-flow:row;width:100%;height:60px;color:#fff}.game-hud .top-bar h1{font-size:38px}.game-hud .top-bar h2{font-size:24px}.game-hud .top-bar h3{font-size:16px}.game-hud .top-bar .left{text-align:left;width:33.33%}.game-hud .top-bar .center{text-align:center;width:33.33%}.game-hud .top-bar .right{text-align:right;width:33.33%}.game-hud .content{flex-grow:1}.game-hud .bottom-bar{height:60px;background-color:rgba(0,0,0,.5)}.level-end{display:flex;flex-direction:column;height:100%;background-color:rgba(0,0,0,.8);justify-content:center;align-items:center}.level-end .title{width:100%;font-size:60px;text-align:center;padding-bottom:32px}.level-end .stat{color:#fff;font-size:32px;padding-bottom:10px}.level-end button{font-size:48px;color:#ff0;background-color:rgba(0,0,0,0);padding-top:20px}", ""]);
// Exports
...
function LevelStart(){return/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"level-start",children:/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"content",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h1",{className:"title",children:"LEVEL START"}),/*#__PURE__*/(0,jsx_runtime.jsx)("button",{className:"start-button",children:"Start"})]})});}
;// CONCATENATED MODULE: ./src/level_end.tsx
// Pad number with leading zeros
function pad(num,size){num=num.toString();while(num.length<size)num="0"+num;return num;}// Format to mm:ss
function formatTime(seconds){var negative=seconds<0?"-":"";var absSeconds=seconds<0?-seconds:seconds;var mins=Math.floor(absSeconds/60);var secs=Math.floor(absSeconds-mins*60);return"".concat(negative).concat(mins,":").concat(pad(secs,2));}function LevelEnd(){var globals=useGlobals();var scoreLevel=useReactiveValue(globals.scoreLevel);var scoreTime=useReactiveValue(globals.scoreTime);var scoreTimeLimit=useReactiveValue(globals.scoreTimeLimit);var scoreDamages=useReactiveValue(globals.scoreDamages);var scoreDeliveries=useReactiveValue(globals.scoreDeliveries);var scoreDeliveriesGoal=useReactiveValue(globals.scoreDeliveriesGoal);var scoreEarnings=useReactiveValue(globals.scoreEarnings);var handleNext=function handleNext(){Interop.GetType('ReactUnityBridge').RestartGameClicked();};return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"level-end",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h1",{className:"title",children:"GAME OVER"}),/*#__PURE__*/(0,jsx_runtime.jsx)("h2",{className:"stat",children:"TIME REMAINING: ".concat(formatTime(scoreTime))}),/*#__PURE__*/(0,jsx_runtime.jsx)("h2",{className:"stat",children:"CURES DELIVERED: ".concat(scoreDeliveries)}),/*#__PURE__*/(0,jsx_runtime.jsx)("h2",{className:"stat",children:"COLLISIONS: ".concat(scoreDamages)}),/*#__PURE__*/(0,jsx_runtime.jsx)("button",{onClick:function onClick(){return handleNext();},children:"RESTART"})]});}
;// CONCATENATED MODULE: ./src/hud.tsx
function Hud(){var globals=useGlobals();var timerText=useReactiveValue(globals.timerText);var money=useReactiveValue(globals.money);var distance=useReactiveValue(globals.distance);var totalDistance=useReactiveValue(globals.totalDistance);var distanceKm=(totalDistance-distance)/1000;return/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"game-hud",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"top-bar",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"left",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h3",{children:"DELIVERED"}),/*#__PURE__*/(0,jsx_runtime.jsx)("h2",{children:"".concat(money)})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"center",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h3",{children:"TIME UNTIL SUNSET"}),/*#__PURE__*/(0,jsx_runtime.jsx)("h1",{children:timerText})]}),/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:"right",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h3",{children:"TO DESTINATION"}),/*#__PURE__*/(0,jsx_runtime.jsx)("h2",{children:"".concat(distanceKm.toFixed(1)," KM")})]})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"content"})]});}
;// CONCATENATED MODULE: ./src/dialogue.tsx
var conversations=new Map();conversations["game_intro"]=[{bg:"",speaker:"Handler",text:"You got the package? Good."},{bg:"",speaker:"Handler",text:"You must get it to the Chairman before sundown, which is... in 3 minutes. You got that?"},{bg:"",speaker:"Agent",text:"3 Minutes?!"},{bg:"",speaker:"Handler",text:"Yeah, so step on the gas. \nAnd careful with the company car -- we'll be deducting the repair fees from your pay."},{bg:"",speaker:"",text:"Use [A] and [D] to move left and right. Press [W] to speed up and [S] to slow down."}];// conversations["boost_intro"] = [
...
// ];
conversations["delivery_intro"]=[{bg:"",speaker:"Handler",text:"Buddy, could you be going any slower?! At this rate you're never gonna make it!"},{bg:"",speaker:"Agent",text:"What do you want me to do? The car only goes so fast!"},{bg:"",speaker:"Handler",text:"Hey, don't worry. You know how there's a deadly disease spreading around the city, \nand our corporation has a monopoly on the cure?"},{bg:"",speaker:"Agent",text:"And that's... not worrying."},{bg:"",speaker:"Handler",text:"I worked out a deal with the folks at R&D. \nThey said they'll make your car faster if you help them deliver the cures."},{bg:"",speaker:"Agent",text:"What? How does that work?"},{bg:"",speaker:"Handler",text:"One of those 'over-the-air-update' thing. \nAnyways, they'll 3D print the cures in your car, just yeet those at hospitals along the way."},{bg:"",speaker:"",text:"Press [E] to deliver a cure. Each successful delivery boosts your max speed."}];conversations["bonus_speed"]=[{bg:"",speaker:"Handler",text:"The R&D folks were impressed by your deliveries! They decided to give you a bit more speed."},{bg:"",speaker:"Handler",text:"Keep making the deliveries to go faster!"}];conversations["jump_intro"]=[{bg:"",speaker:"Handler",text:"Looks like there's a lot of traffic ahead."},{bg:"",speaker:"Agent",text:"Yeah I can't get past that no matter how fast I go."},{bg:"",speaker:"Handler",text:"I'll get them to unlock your car's vertical mobility system. That should help you out."},{bg:"",speaker:"",text:"Press [Space] to jump."}];// conversations["unlimited_intro"] = [
...
// ];
conversations["ending_good"]=[{bg:"",speaker:"Agent",text:"Looks like I made it..."},{bg:"end_1",speaker:"Agent",text:"Mr. Chairman? I have the delivery for you."},{bg:"good_end",speaker:"Chairman",text:"Ah! Ice cream from The Scoop. A special treat!"},{bg:"good_end",speaker:"Chairman",text:"And it hasn't melted yet. Well done agent. We'll give you a promotion."}];conversations["ending_bad"]=[{bg:"",speaker:"Agent",text:"Guess I couldn't make it in time..."},{bg:"end_1",speaker:"Agent",text:"Mr. Chairman? Express delivery for you."},{bg:"bad_end",speaker:"Chairman",text:"Ah! Ice cream from The Scoop. A special treat!"},{bg:"bad_end",speaker:"Chairman",text:"What is this? It's all MELTED! Have this guy fired!"}];function Dialogue(){var globals=useGlobals();var continueValue=useReactiveValue(globals["continue"]);var conversationKey=useReactiveValue(globals.conversationKey);var _useState=(0,react.useState)(0),_useState2=slicedToArray_slicedToArray(_useState,2),index=_useState2[0],setIndex=_useState2[1];var currentConversation=conversations[conversationKey];var currentMessage=currentConversation?currentConversation[index]:null;var hasNext=currentConversation&&currentConversation.length>index+1;var bgImage=currentMessage?currentMessage.bg?currentMessage.bg:"none":"none";var handleNext=function handleNext(){// Advance conversation or call DialogueFinished
if(hasNext){setIndex(index+1);}else{Interop.GetType('ReactUnityBridge').DialogueFinished();}};(0,react.useEffect)(function(){if(continueValue>0){handleNext();Interop.GetType('ReactUnityBridge').ResetContinue();}},[continueValue,handleNext]);return/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"dialogue-background",style:{backgroundImage:"url(res:"+bgImage+")"},children:/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"dialogue-bar",children:[/*#__PURE__*/(0,jsx_runtime.jsxs)("view",{className:"content",children:[/*#__PURE__*/(0,jsx_runtime.jsx)("h1",{className:"title",children:currentMessage?currentMessage.speaker:""}),/*#__PURE__*/(0,jsx_runtime.jsx)("view",{className:"gradient-rule"}),/*#__PURE__*/(0,jsx_runtime.jsx)("p",{className:"message",children:currentMessage?currentMessage.text:""})]}),/*#__PURE__*/(0,jsx_runtime.jsx)("button",{onClick:function onClick(){return handleNext();},children:hasNext?"CONTINUE":"START"})]})});}
;// CONCATENATED MODULE: ./src/index.tsx
function App(){var globals=useGlobals();var route=useReactiveValue(globals.route);var navigate=useNavigate();(0,react.useEffect)(function(){// console.log(`Navigate to route: ${route}`);
navigate(route);},[route,navigate]);return/*#__PURE__*/(0,jsx_runtime.jsxs)(Routes,{children:[/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/",element:/*#__PURE__*/(0,jsx_runtime.jsx)("view",{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/title",element:/*#__PURE__*/(0,jsx_runtime.jsx)(TitleScreen,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/pause",element:/*#__PURE__*/(0,jsx_runtime.jsx)(Pause,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/level_start",element:/*#__PURE__*/(0,jsx_runtime.jsx)(LevelStart,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/level_end",element:/*#__PURE__*/(0,jsx_runtime.jsx)(LevelEnd,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/hud",element:/*#__PURE__*/(0,jsx_runtime.jsx)(Hud,{})}),/*#__PURE__*/(0,jsx_runtime.jsx)(Route,{path:"/dialogue",element:/*#__PURE__*/(0,jsx_runtime.jsx)(Dialogue,{})})]});}_render(/*#__PURE__*/(0,jsx_runtime.jsx)(MemoryRouter,{children:/*#__PURE__*/(0,jsx_runtime.jsx)(App,{})}));
})();
